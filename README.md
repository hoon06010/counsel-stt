...
> **ARM64 참고**: `faster-whisper`는 내부적으로 `ctranslate2`를 사용합니다.  
> `ctranslate2 4.x` 이상부터 ARM64 Windows 공식 wheel을 제공하며,  
> `faster-whisper 1.1.0` 이상을 사용하면 자동으로 호환 버전이 설치됩니다.
